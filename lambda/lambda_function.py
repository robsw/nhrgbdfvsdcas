...
STREAMS = [
  {
    "token": '1',
    "url": 'https://live.raveradio.net/128',
    "metadata": {
      "title": 'Rave Radio',
      "subtitle": '',
      "art": {
        "sources": [
          {
            "contentDescription": 'raveradio.net',
            "url": 'https://robsw.co.uk/rave512.png',
            "widthPixels": 512,
            "heightPixels": 512
          }
        ]
      ...
      "backgroundImage": {
        "sources": [
          {
            "contentDescription": 'Rave Radio',
            "url": 'https://robsw.co.uk/raveresize.jpg',
            "widthPixels": 1200,
            "heightPixels": 800
          }
        ]
